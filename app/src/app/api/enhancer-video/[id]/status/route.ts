/**
 * GET /api/enhancer-video/[id]/status
 *
...
import { getVideoJobStatus } from '@/helpers/enhancer-video/videoProcessingClient';
import { db } from '@/libs/core/DB';
import { enhancementJobs, EVideoJobStatus, videos } from '@/models/Schema';
      ...
      if (pythonStatus.status === 'done') {
        await db
          ...
          .set({
            ...
            progress: 100,
            stageLabel: 'Done',
            resultUrl: pythonStatus.output_url,
