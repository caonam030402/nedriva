 ...
 * @param durationSecs
 */
export async function getSignedResultUrl(key: string, durationSecs = 3600): Promise<string> {
 ...
 * @param destKey
 */
export async function uploadFromUrlToR2(sourceUrl: string, destKey: string): Promise<string> {
