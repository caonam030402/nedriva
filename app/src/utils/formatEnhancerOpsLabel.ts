import { EMoreModel, ESizeMode, EUpscaleModel } from '@/enums/enhancer';
...
export function scaleFactorFromStoredOps(
  ...
  if (ops.sizeMode === ESizeMode.Scale && typeof ops.scaleFactor === 'number' && Number.isFinite(ops.scaleFactor)) {
