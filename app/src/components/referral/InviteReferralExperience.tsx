...
function ReferralShareIllustration(props: { className?: string }) {
  return (
    <svg viewBox="0 0 200 200" className={props.className} aria-hidden>
      ...
      <circle cx="100" cy="100" r="58" fill="none" stroke="url(#invite-art-violet)" strokeWidth="1" opacity="0.35" />
      <path
      ...
      <g filter="url(#invite-art-glow)">
        <circle cx="52" cy="102" r="22" fill="#1e1b2e" stroke="url(#invite-art-violet)" strokeWidth="2" />
        <circle cx="148" cy="102" r="22" fill="#1e1b2e" stroke="url(#invite-art-mint)" strokeWidth="2" />
        <rect
          x="84"
          y="86"
          width="32"
