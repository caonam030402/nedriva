...
import type { ReferralDetailsModalCopy } from '@/components/referral/ReferralDetailsModal';
import { useState } from 'react';
import { ReferralDetailsModal } from '@/components/referral/ReferralDetailsModal';
