...
const FEATURE_ROWS: {
  ...
  titleKey: 'f1_title' | 'f2_title' | 'f3_title' | 'f4_title' | 'f5_title' | 'f6_title';
  descKey: 'f1_desc' | 'f2_desc' | 'f3_desc' | 'f4_desc' | 'f5_desc' | 'f6_desc';
}[] = [
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8">
          <div>
            ...
            <p className="mt-6 text-sm opacity-75">
              <Link
                href={pricingHref}
                className="font-medium underline decoration-white/30 underline-offset-4 hover:opacity-100"
              >
            ...
            {faqs.map((item, i) => (
              ...
              >
                <summary className="flex cursor-pointer list-none items-center justify-between gap-4 px-4 py-4 text-left font-medium sm:px-5">
                  <span>{item.q}</span>
                  <span className="shrink-0 text-subtle transition-transform group-open:rotate-180">
                    ▼
                  </span>
                </summary>
