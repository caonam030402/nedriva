  ...
  return (
    <section className="relative overflow-hidden bg-page">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 pt-20 pb-24 sm:px-6 sm:pt-28 sm:pb-32 lg:px-8">
        ...
        {/* ── Headline ── */}
        <h1 className="mx-auto max-w-4xl text-center font-display text-5xl leading-[1.08] font-semibold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
          {t('headline')}
          {' '}
          <span
        ...
        <div id="demo" className="relative mt-16 sm:mt-20">
          ...
          {/* Demo card */}
          <div className="glass relative rounded-card p-2 shadow-card sm:p-3">
          ...
          <div className="absolute top-1/4 -left-4 hidden xl:block">
            <div className="glass rounded-card p-3 shadow-card">
          ...
          <div className="absolute top-2/3 -right-4 hidden xl:block">
            <div className="glass rounded-card border border-success/20 p-3 shadow-card">
              <div className="flex items-center gap-2">
