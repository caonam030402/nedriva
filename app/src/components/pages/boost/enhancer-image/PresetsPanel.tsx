...
export const PresetsPanel = (props: Props) => {
  ...
  return (
    ...
    <div className="grid h-full min-h-0 w-full flex-1 grid-rows-[minmax(0,1fr)_auto] overflow-hidden">
      <div className="isolate min-h-0 touch-pan-y overflow-y-auto overscroll-y-contain px-4 pt-4 pb-2 [-webkit-overflow-scrolling:touch]">
        <SelectableList groups={GROUPS} value={selected} onChange={setSelected} />
      </div>
