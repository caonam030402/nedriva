...
/** Client-side poll interval (ms) for job status — frontend polling only. */
export const ENHANCER_JOB_POLL_INTERVAL_MS = JOB_POLL_INTERVAL_MS;

/**
 * Max number of client-side polls before declaring timeout.
 *  960 × 2 s = 32 min — must stay in sync with backend JOB_PIPELINE_TIMEOUT_S.
 */
export const ENHANCER_JOB_MAX_POLLS = JOB_MAX_POLLS;
