...
/** Cap on how many history rows can be requested in one call. */
export const ENHANCER_HISTORY_MAX_LIMIT = 100;

/** Cap on how many runs rows can be requested in one call. */
export const ENHANCER_RUNS_MAX_LIMIT = 100;
